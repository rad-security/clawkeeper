...
const ZONE_MAP: Record<string, ZoneName> = {
  ...
  "Skills Prompt Injection": "tools",
  "Session Prompt Injection": "tools",
  "Session Rogue Commands": "tools",
  "Memory Prompt Injection": "tools",
  "Log File Content": "tools",
...
const PHASE_MAP: Record<string, Phase> = {
  ...
  "Elevated Tools": "security_audit",
  "Browser Control": "security_audit",
  "Group Mention Policy": "security_audit",
  "Group Access Policy": "security_audit",
  "Plugin Allowlist": "security_audit",
  "Trusted Proxies": "security_audit",
  "Tool Deny List": "security_audit",
  "Credential Store": "security_audit",
  "Credential Directory": "security_audit",
  "Credential Files": "security_audit",
  "OAuth Profiles": "security_audit",
  "Session Transcripts": "security_audit",
  "Log Files": "security_audit",
  "OpenClaw Config": "security_audit",
  ...
  "Skills Prompt Injection": "security_audit",
  "Session Prompt Injection": "security_audit",
  "Session Rogue Commands": "security_audit",
  "Memory Prompt Injection": "security_audit",
  "Log File Content": "security_audit",
  ...
  "AirDrop & Handoff": "host_hardening",
  "Firewall": "host_hardening",
  "Analytics & Telemetry": "host_hardening",
  "FileVault": "host_hardening",
  "Spotlight Indexing": "host_hardening",
  ...
  "PermitRootLogin": "host_hardening",
  "PasswordAuthentication": "host_hardening",
  "X11Forwarding": "host_hardening",
  "MaxAuthTries": "host_hardening",
  "Disk Encryption": "host_hardening",
  "Auto Updates": "host_hardening",
  ...
  "Docker Settings": "prerequisites",
  "Docker Group": "prerequisites",
  "Essentials": "prerequisites",
  "OpenClaw npm": "prerequisites",
  "OpenClaw Version": "prerequisites",
};
