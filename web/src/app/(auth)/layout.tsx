...
export const metadata: Metadata = {
  ...
  description:
    "Create a free Clawkeeper account. Monitor your OpenClaw deployments with automated security checks, letter grades, and real-time alerts. No credit card required.",
  openGraph: {
