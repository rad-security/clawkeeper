...
If you have an API key configured, each scan's grade and score are sent to the [dashboard](/dashboard). The dashboard tracks your grade over time so you can spot regressions and config drift.

See [Configuration](/docs/configuration) for how to set up the agent.
