...
4. **OpenClaw Installation** — deployment mode selection and OpenClaw setup
5. **Security Audit** (13 checks) — credential exposure, prompt injection detection, rogue command scanning, CVE vulnerability audit, gateway hardening, SOUL.md integrity, skills analysis, log file auditing
